<?php
// FTP upload script voor gebouwde React app (build folder)

$ftp_server = "ftp.raakachterbos.be";
$ftp_username = "raakachterbos.be";
$ftp_password = "Raakachterbos.1";

// Check of build folder bestaat
if (!is_dir(__DIR__ . '/build')) {
    die("❌ Build folder niet gevonden!\n\nVoer eerst uit: npm run build\n");
}
...
echo "Start uploaden van build folder naar /raak op server...\n\n";

// Ga naar root directory
ftp_chdir($conn, '/');

$start_time = microtime(true);
$stats = ftp_upload_recursive($conn, __DIR__ . '/build', 'raak');

// Upload ook de PHP folder
echo "\nUploaden PHP bestanden...\n";
